...
// ---------------------------------------
// Parametr do zmiany liczby losowo wyœwietlanych punktów
...
GLfloat coord[NUMBER_OF_POINTS] = {};

// ---------------------------------------

void DrawRandomPoints(GLfloat tablica[] ){

for (int i; i<NUMBER_OF_POINTS*3*2; i++) {
